      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-8 pt-12 border-t border-border">
          <div>
            ...
            <p className="text-sm text-foreground/60">Less Manual Work</p>
          </div>
          <div>
            <p className="text-3xl md:text-4xl font-bold text-primary mb-2">3x</p>
            <p className="text-sm text-foreground/60">More Leads</p>
          </div>
          <div>
            <p className="text-3xl md:text-4xl font-bold text-primary mb-2">30 Days</p>
            <p className="text-sm text-foreground/60">To Live</p>
          </div>
        </div>
      </div>
    </section>
